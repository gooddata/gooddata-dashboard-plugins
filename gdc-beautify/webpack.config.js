...
const gooddataSharePackagesEntries = [
    ...Object.keys(deps),
    ...Object.keys(peerDeps),
]
    .filter(
        (pkg) =>
            pkg.startsWith("@gooddata") && pkg !== "@gooddata/sdk-ui-dashboard"
    )
    .reduce((acc, curr) => {
        acc[curr] = {
            singleton: true,
...
module.exports = (_env, argv) => {
    ...
    const commonConfig = {
        ...
        resolve: {
            ...
            alias: {
                ...
                "@gooddata/sdk-ui-dashboard": path.resolve(
                    "./node_modules/@gooddata/sdk-ui-dashboard"
                ),
                "@gooddata/sdk-ui-ext": path.resolve(
                    "./node_modules/@gooddata/sdk-ui-ext"
                ),
                "~components": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/components/"
                ),
                "~pages": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/pages/"
                ),
                "~css": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/css/"
                ),
                "~icons": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/icons/"
                ),
                "~images": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/images/"
                ),
                images: path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/images/"
                ),
                "~styleGuide": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/styleGuide/"
                ),
                "~constants": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/constants/"
                ),
                "~utils": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/utils/"
                ),
                "~contexts": path.resolve(
                    __dirname,
                    "./src/dp_gdc_beautify/beautify/contexts/"
                ),
            },
        ...
        module: {
            rules: [
                        ...
                        },
                        {
                            ...
                            options: {
                                resources: path.resolve(
                                    __dirname,
                                    "./src/dp_gdc_beautify/beautify/css/variables/**/*.scss"
                                ),
                            },
                        },
                    ],
                ...
                {
                    test: /\.(eot|woff|ttf|jpg|jpeg|gif)/,
                    type: "asset/resource",
                },
                !isProduction && {
                    test: /\.js$/,
    ...
    return [
        ...
        },
        {
            ...
            output: {
                ...commonConfig.output,
                path: path.join(__dirname, "dist", "dashboardPlugin"),
            },
            plugins: [
                ...commonConfig.plugins,
