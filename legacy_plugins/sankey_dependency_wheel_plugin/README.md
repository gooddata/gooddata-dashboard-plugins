# GoodData.UI Dashboard Plugin - Sankey Dependency Wheel
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_sankey_dependency_wheel_plugin.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_sankey_dependency_wheel_plugin](./src/dp_sankey_dependency_wheel_plugin/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_sankey_dependency_wheel_plugin](./src/dp_sankey_dependency_wheel_plugin) directory.

The [src/dp_sankey_dependency_wheel_plugin\_engine](./src/dp_sankey_dependency_wheel_plugin_engine) and [src/dp_sankey_dependency_wheel_plugin\_entry](./src/dp_sankey_dependency_wheel_plugin_entry) directories contain essential plugin boilerplate.
