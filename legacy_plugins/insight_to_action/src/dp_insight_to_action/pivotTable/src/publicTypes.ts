...
import { TotalType, IExecutionConfig, ISeparators, ITheme } from "@gooddata/sdk-model";
import {
...
export interface IPivotTableBucketProps {
    ...
    // Custom pivot button used for dashboard plugin
    customPivotButton?: boolean;
}
