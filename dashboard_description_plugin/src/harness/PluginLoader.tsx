...
import { CustomToolbarComponent, DashboardConfig } from "@gooddata/sdk-ui-dashboard"; // this import will be renamed in plugin-toolkit
import { ErrorComponent, LoadingComponent } from "@gooddata/sdk-ui";

import PluginFactory from "../dp_dashboard_description_plugin/index.js";
import { localParams } from "../dp_dashboard_description_plugin/config.js";
...
export const PluginLoader = () => {
    ...
    }, [hidePluginOverlays, isHideOverlaysEnabled]);
    ...
    }, [hidePluginsOverlaysCallbacks, isHideOverlaysEnabled, isPluginEnabled, reloadPlugins, togglePlugin]);
